import SpecialtyModel from "#src/models/specialtiesModel.js"
...
class SpecialtyController {
    ...
    getById = async (req, res) => {
        ...
        const data = await SpecialtyModel.getById(id)
    ...
    async create(req, res) {
        const data = await SpecialtyModel.create(req.body)
        res.status(data.code).send(data)
    }

    async update(req, res) {
        const data = await SpecialtyModel.update(req.params.id, req.body)
        res.status(data.code).send(data)
    }

    async disable(req, res) {
        const data = await SpecialtyModel.disable(req.params.id)
        res.status(data.code).send(data)
    }
}
